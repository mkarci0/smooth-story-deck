...
export function CaseStudySideNav({
  ...
  return (
    <>
      ...
      {showDesktop && (
        <aside className="hidden xl:block sticky top-24 max-h-[calc(100vh-3rem)]">
          <div className="w-[220px] rounded-2xl border border-border/60 bg-background/88 backdrop-blur-sm p-3 flex flex-col max-h-[calc(100vh-3rem)]">
